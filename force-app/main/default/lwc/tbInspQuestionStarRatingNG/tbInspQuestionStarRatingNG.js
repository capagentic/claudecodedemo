...
export default class TbInspQuestionStarRatingNG extends LightningElement {
    ...
    setRating(value) {
        ...
        const selectedValue = this.rating + '';
    ...
    getColor(rating, numOfStars, staticColor) {
        ...
        if (rating > partitionValue) {
            color = this.colorOk;
        }
        if (rating > partitionValue + 2) {
            color = this.colorPositive;
        }
