...
export default class SeqRenderer extends LightningElement {
    ...
    get showSubmitButton() {
        return (this.isLastQuestion && !this.showSalesforceFlow);
    }
    ...
    showQuestionComponent(currentQuestion, currentIndex, totalNumber) {
        ...
        if(currentQuestion.fieldType == 'Salesforce Flow') {
            ...
            //this.childComponentName = 'c-seq-question-salesforce-flow';
        }
        ...
        if (currentIndex == 0) {
            ...
            this.showQuestionProgress = (totalNumber == 1 ? false : true);
        } else {
    ...
    handleValueChanged(event) {
        ...
        console.log('before value change function processing - in redenrer lwc');
        ...
        this.result = JSON.stringify(this.answers);
        console.log('after value change function processing - in redenrer lwc');
    }
    ...
    updateQuestion(q, answer) {
        ...
        for (var i = 0; i < this.questions.length; i++) {
            if (this.questions[i].index == q.index 
                ...
                this.totalScore = this.totalScore + answer.attainedScore || 0;
                break;
            }
        }
    }
