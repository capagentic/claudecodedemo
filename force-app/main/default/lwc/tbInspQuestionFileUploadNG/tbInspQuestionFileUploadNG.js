...
export default class TbInspQuestionFileUploadNG extends LightningElement {
    @api question = {};
    options = [];
    @api readOnly = false;
    ...
    handleChange(event) {
        ...
        var inspectionName = this.inspectionRec?.Name || '';
        ...
        if (validImageTypes.includes(fileType)) {
            fileCon['updatedname'] = inspectionName + ' (Q' + this.question.index + ') ' + dateValue + '.' + ext;
            this.fileName = fileCon['updatedname'];
        } else {
            fileCon['updatedname'] = inspectionName + ' (Q' + this.question.index + ') ' + dateValue + ' ' + fileCon['name'];
            this.fileName = fileCon['updatedname'];
        }
